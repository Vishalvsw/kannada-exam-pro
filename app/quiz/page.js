      ...
      <div className="max-w-md mx-auto px-4 py-3">
        ...
        <div className="bg-white rounded-xl shadow-md overflow-hidden mb-4 border border-gray-100">
          ...
          {isOrdering ? (
            <OrderingQuestion 
              ...
              isAnswered={isQuestionAnswered || showExplanation}
            />
          ) : (
        ...
        <div className="flex gap-2 mt-2">
          <button 
            ...
            disabled={(!showExplanation && !selectedAnswer) || quizLocked || (isOrdering && selectedAnswer && selectedAnswer.split(',').length < 5)}
          >
