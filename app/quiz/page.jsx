        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="bg-yellow-50 rounded-xl p-4 mb-6 border border-yellow-200">
            <p className="text-sm text-yellow-800 text-center">
              {percentage >= 80 ? '🏆 Excellent! You\'re a champion!' :
               percentage >= 60 ? '👍 Good job! Keep practicing!' :
               percentage >= 40 ? '📚 Keep learning! You\'ll do better next time!' :
      ...
      <div className="max-w-md mx-auto px-4 py-4">
        ...
        <div className="flex justify-between items-center mb-6 gap-3">
          ...
          <div className="flex-1 bg-white rounded-2xl px-4 py-3 shadow-sm border border-gray-100">
            ...
            <div className={`flex items-baseline gap-1 ${timeLeft <= 10 ? 'text-red-600 animate-pulse' : 'text-gray-700'}`}>
        ...
        {/* Native Ad - Between Score and Progress */}
        ...
        <div className="mt-6 pt-4 border-t border-gray-100 text-center">
          <p className="text-xs text-gray-400">📝 Practice unlimited times</p>
        </div>
      </div>

      {/* Native Ad - Before Bottom Nav */}
      <AdSpace type="inArticle" className="mx-4 my-2" />
      <AdSpace type="banner" className="mx-4 mt-2" />
