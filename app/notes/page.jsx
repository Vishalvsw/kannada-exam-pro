...
import { getNotes, getQAQuestions } from '@/app/utils/api';
import NotesClient from './NotesClient';

export const metadata = {
  title: 'Karnataka Exam Study Notes | Free KAS, PSI, PDO Preparation',
  description: 'Free study notes for Karnataka competitive exams including KAS, PSI, PDO, FDA, SDA. Comprehensive notes with subject-wise organization and practice questions with detailed explanations.',
  keywords: 'Karnataka exam notes, KAS study material, PSI preparation, PDO exam notes, Kannada exam preparation, Karnataka history notes, reasoning practice, quantitative aptitude',
  openGraph: {
    title: 'Karnataka Exam Study Notes - KannadaExamPro',
    description: 'Free study notes for Karnataka competitive exams. Practice with 1000+ questions and detailed explanations.',
